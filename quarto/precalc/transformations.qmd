...
We can be more precise. In $2015$ the longest day in New York City was June $21$st, with $15$h $8$m $55$s of sunlight; the shortest was December $21$st, with $9$h $18$m $23$s. On March $21$st there were $12$h $13$m $42$s of sunlight.
...
To test the model, take a day it was not built from: September $23$rd, $2015$ had $12$h $10$m $38$s of sunlight. This is day $266$ (`Date(2015, 9, 23) - Date(2015, 1, 1) + Day(1)`). Our model prediction has a difference of


```{julia}
observed = 12 + 10/60 + 38/60/60
delta = (newyork(266) - observed) * 60
```
